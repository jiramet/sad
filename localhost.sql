...
--
-- Host: localhost
-- Generation Time: May 08, 2012 at 01:01 PM
...
INSERT INTO `member` (`m_id`, `m_username`, `m_password`, `m_title`, `m_name`, `m_surname`, `m_session`, `m_email`, `m_tel`, `m_address`) VALUES
...
INSERT INTO `orders` (`o_id`, `o_mid`, `o_pid`, `o_item`, `o_price`, `o_day`, `o_month`, `o_year`, `o_status`, `o_note`) VALUES
