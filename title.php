...
<?php
	...
	$dbcp = _TITLE; //dbcp = database connect page ดาต้าเบส ที่ใช้ ในหน้านี้
	...
	$tableallsize = '45%'; //ขนาดตารางทั้งหมด
	$headtable = array('คำนำหน้าชื่อ', 'การกระทำ'); //หัวตาราง ที่จะนำไป loop หัวตาราง แสดงผล  หน้าแรก
	$counts = count($headtable); //นับจำนวน สมาชิค ใน Array
	$tablesizes = array('37%', '50%'); //ขาดในแต่ละช่อย  อ่างอิงจาก $headtable
...
<div>
<?php
	echo fperurl($_GET['f'], 'add', '', 'เพิ่มคำนำหน้าชื่อ', $wurl3->mp_aper);
?>  
</div>
...
?>
            <div align="center">
                    ...
                    <table width="500" border="0" cellspacing="5" cellpadding="5">
                        <tr>
                            <td colspan="2"><div align="center"><a name="link1">กรอกข้อมูลคำนำหน้าชื่อ</a></div></td>
                        </tr>
                        <tr>
                            <td width="120"><div align="right">คำนำหน้าชื่อ</div></td>
