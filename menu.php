		...
		if ($showme->$value [5] == 0) {
			?>
		  	...
		  	<form name="form3" method="post"
								action="index.php?f=<?php echo $_GET[f];?>&action=editshow&id=<?php echo $showme->w_id?>">
								<input name="status" type="hidden" value="1" />
								<center>
									<input name="test" type="submit" value=" แสดงMenu " />
								</center>
							</form>
		  	<?php
		} else {
			?>
		  	<form name="form3" method="post"
								...
								<center></center>
								<input name="test" type="submit" value="ไม่แสดงMenu" />
								</center>
							</form>
		  	<?php
		}
...
<?php
	...
	?>
			...
			<form name="form2" method="post"
				action="index.php?f=<?php echo $_GET[f];?>&action=saveadd">
				<table width="500" border="0" cellspacing="5" cellpadding="5">
					<tr>
						<td colspan="2"><div align="center">
								<a name="link1">กรอกข้อมูลUrl</a>
							</div></td>
					</tr>
					<tr>
						<td width="120"><div align="right">ชื่อ Menu</div></td>
						<td width="374"><input name="<?php echo $value[2];?>" type="text"
							id="<?php echo $value[2];?>" size="50"></td>
					</tr>
					<tr>
						<td width="120"><div align="right">URL</div></td>
						<td width="374"><input name="<?php echo $value[3];?>" type="text"
							id="<?php echo $value[3];?>" size="50"></td>
					</tr>
					<tr>
						<td width="120"><div align="right">URL Full</div></td>
						<td width="374"><input name="<?php echo $value[4];?>" type="text"
							id="<?php echo $value[4];?>" size="50"> <input
							name="<?php echo $value[5];?>" type="hidden"
							id="<?php echo $value[5];?>" value="0" size="50"></td>
					</tr>
					<tr>
						<td width="120"><div align="right">หมายเหตุ</div></td>
						<td width="374"><input name="<?php echo $value[6];?>" type="text"
							id="<?php echo $value[6];?>" size="50"></td>
					</tr>
					<tr>
...
<?php
	...
	if ($m->$value [1]) {
		?>
                <div align="center">
			<form name="form3" method="post"
				action="index.php?f=<?php echo $_GET[f];?>&action=saveedit&id=<?php echo $id; ?>">
				<table width="500" border="0" cellspacing="5" cellpadding="5">
					<tr>
						<td colspan="2"><div align="center">
								<a name="link1">กรอกข้อมูลที่ต้องการแก้ไข</a>
							</div></td>
					</tr>
					<tr>
						<td width="120"><div align="right">ชื่อ Menu</div></td>
						<td width="374"><input name="<?php echo $value[2];?>" type="text"
							id="<?php echo $value[2];?>" value="<?php echo $m->$value[2]; ?>"
							size="50"></td>
					</tr>
					<tr>
						<td width="120"><div align="right">URL</div></td>
						<td width="374"><input name="<?php echo $value[3];?>" type="text"
							id="<?php echo $value[3];?>" value="<?php echo $m->$value[3]; ?>"
							size="50"></td>
					</tr>
					<tr>
						<td width="120"><div align="right">URL Full</div></td>
						<td width="374"><input name="<?php echo $value[4];?>" type="text"
							id="<?php echo $value[4];?>" value="<?php echo $m->$value[4]; ?>"
							size="50"></td>
					</tr>
					<tr>
						<td width="120"><div align="right">หมายเหตุ</div></td>
						<td width="374"><input name="<?php echo $value[6];?>" type="text"
							id="<?php echo $value[6];?>" value="<?php echo $m->$value[6]; ?>"
							size="50"></td>
					</tr>
					<tr>
						<td><div align="right"></div></td>
