...
<?php
	...
	$tableallsize = '95%'; //ขนาดตารางทั้งหมด
	...
	$tablesizes = array('25%', '40%', '40%'); //ขาดในแต่ละช่อย  อ่างอิงจาก $headtable
...
<div>
<?php
	echo fperurl($_GET['f'], 'add', '', 'Add Permission Group', $wurl3->mp_aper);
?>  
</div>
                ...
                <div class="center">
                    <div align="center" id="showdata">
                        <table width="500" border="1" cellspacing="0" cellpadding="0">
                            <tr> 
                                <td colspan="2"><div align="center"><a name="link1">Permission Name Group</a></div></td>
                            </tr>
                            <tr>
                                <td width="130"><div align="right">Permission ID</div></td>
                                <td width="374"><div align="left"><?php echo $mid; ?> </div></td>
                            </tr>
                            <tr>
                                <td><div align="right">Primission Group Name</div></td>
...
?>
            <div align="center">
                    ...
                    <table width="500" border="0" cellspacing="5" cellpadding="5">
                        <tr>
                            <td colspan="2"><div align="center"><a name="link1">กรอกข้อมูลPermission Name Group</a></div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="120"><div align="right">Remark</div></td>
