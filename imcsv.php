...
?>
                            <tr bgcolor= <?php echo $colors[$i%count($colors)]; ?>>
                                ...
                                <td><?php echo $showme->$value[14]; ?></td>
                                <td><?php echo $showme->$value[1]; ?></td>
                                <td><?php echo $showme->$value[4]; ?></td>
                                <td><?php echo $showme->$value[29]; ?></td>
            ...
            <div align="center">
  			<form action="index.php?f=<?php echo $_GET[f]; ?>&action=saveadd" method="post" enctype="multipart/form-data" name="form1">
  				<table width="95%" border="1" cellspacing="5" cellpadding="5">
    				<tr>
       					 <td colspan="2"><div align="center"><a name="link1">
...
?>
               <div align="center">
  			<form action="index.php?f=<?php echo $_GET[f]; ?>&action=saveedit" method="post" enctype="multipart/form-data" name="form1">
  				<table width="95%" border="1" cellspacing="5" cellpadding="5">
    				<tr>
       					 <td colspan="2"><div align="center"><a name="link1">
						<label for="1">กรุณาเลือก File ที่จะนำเข้า Databases (File CSV)</label>
