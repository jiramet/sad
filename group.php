...
<?php
	...
	$dbcp = _GRO; //dbcp = database connect page ดาต้าเบส ที่ใช้ ในหน้านี้

	$headtext = 'ระบบGroup'; //ส่วนหัว Page
	//Setting Page
	//$number_per_page = 10; //กำหนดให้แสดง 10 แถวต่อเพจ

	//start------------------จัดการเรื่องตารางหน้าแสดงผล-----------------------
	$tableallsize = '80%'; //ขนาดตารางทั้งหมด
	$headtable = array('ชื่อย่อGroup', 'ชื่อเต็ม Group', 'การกระทำ'); //หัวตาราง ที่จะนำไป loop หัวตาราง แสดงผล  หน้าแรก
	$counts = count($headtable); //นับจำนวน สมาชิค ใน Array
	$tablesizes = array('15%', '37%', '37%'); //ขาดในแต่ละช่อย  อ่างอิงจาก $headtable
            ...
            <div align="center">
                    ...
                    <table width="500" border="0" cellspacing="5" cellpadding="5">
                        ...
                        <tr>
                            ...
                            <td width="374"><input name="<?php echo $value[4];?>" type="text" id="<?php echo $value[4];?>" size="50"></td>
                        </tr>
                        <tr>
